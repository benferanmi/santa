        ...
        <div className="relative py-10 overflow-hidden bg-[url(https://res.cloudinary.com/dtcbirvxc/image/upload/v1748293560/h8ymkm0jxerxeqrhcq6m.jpg)]">
            ...
            <div className="relative z-10 container mx-auto px-4 py-16 flex flex-col justify-center items-center">
                ...
                <motion.div
                    ...
                    className="text-center mb-12 bg-red-800 px-10 py-6 rounded-sm"
                >
                            ...
                            {!isPlaying ? (
                                ...
                                <div className="relative w-full h-full bg-gradient-to-br from-red-600 to-green-700 flex items-center justify-center">
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="relative z-10 bg-red-600 hover:bg-red-700 text-white rounded-full p-6 shadow-2xl transition-all duration-300 group"
                                    >
                                        <motion.div
                ...
                >
                    <p className="text-xl text-white/90 mb-6 max-w-2xl bg-black/50 p-2.5 bg-opacity-70">
                        Experience the magic of Christmas as Santa brings joy to children around the world!
                        Watch exclusive behind-the-scenes footage from the North Pole.
                    </p>
                    <motion.button
                        whileHover={{ scale: 1.05, boxShadow: "0 10px 30px rgba(239, 68, 68, 0.4)" }}
                        whileTap={{ scale: 0.95 }}
                        className="bg-red-800 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                        🎅 More Santa Videos
                    </motion.button>
                </motion.div>
