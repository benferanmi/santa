              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div className="relative">
                    <User
                      className="absolute left-4 top-1/2 transform -translate-y-1/2 text-black/40"
                      size={20}
                    />
                    <input
                      type="text"
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    >
                      <Upload
                        className="mx-auto mb-4 text-black/60"
                        size={32}
                      />
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-amber-500/90 text-sm leading-relaxed">
                    The final video will be delivered to your email within 24
                    hours after purchase. Make sure to check your spam folder if
                    you don't see it.
                  </p>
                </div>
              </div>
