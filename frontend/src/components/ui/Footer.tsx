        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-base-100 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                target="_blank"
                className="bg-base-100 bg-opacity-10 hover:bg-opacity-20 rounded-full p-3 transition-all duration-200 hover:scale-110"
                aria-label="Facebook"
              >
                <Facebook className="w-6 h-6 fill-secondary" />
              </a>
              <a
                ...
                aria-label="YouTube"
              >
                <Youtube className="w-6 h-6 fill-secondary" />
              </a>
              <a
                ...
                aria-label="Twitter"
              >
                <Twitter className="w-6 h-6 fill-secondary" />
              </a>
            </div>
          </div>
