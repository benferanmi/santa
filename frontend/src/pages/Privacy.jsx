...
import { Shield, Eye, Lock, Users, FileText, Clock, ChevronRight, ArrowUp } from 'lucide-react';
...
const PrivacyPolicyPage = () => {
    ...
    const tableOfContents = [
        ...
        { id: 'information-we-collect', title: 'Information We Collect', icon: <Eye className="w-4 h-4" /> },
        { id: 'how-we-use', title: 'How We Use Your Information', icon: <Users className="w-4 h-4" /> },
        { id: 'information-sharing', title: 'Information Sharing', icon: <Shield className="w-4 h-4" /> },
        ...
        { id: 'children-privacy', title: 'Children\'s Privacy', icon: <Shield className="w-4 h-4" /> },
        { id: 'updates', title: 'Policy Updates', icon: <Clock className="w-4 h-4" /> },
        { id: 'contact', title: 'Contact Us', icon: <FileText className="w-4 h-4" /> }
    ];
                ...
                <div className="grid lg:grid-cols-4 gap-12">
                                ...
                                <nav className="space-y-1">
                                    {tableOfContents.map((item) => (
                                        <button
                                            ...
                                            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-left transition-all duration-200 ${activeSection === item.id
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 border border-gray-100">
                            ...
                            <section id="introduction" data-section="introduction" className="mb-12">
                                ...
                                <div className="prose prose-gray max-w-none">
                                    <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                        Welcome to Wishes! We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our personalized Santa video service.
                                    </p>
                                ...
                                <div className="space-y-6">
                                    <div className="bg-gray-50 rounded-xl p-6">
                                        ...
                                        <ul className="text-gray-700 space-y-2">
                                            <li>• Child's name and age for video personalization</li>
                            ...
                            <section id="how-we-use" data-section="how-we-use" className="mb-12">
                                <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm">Create and deliver personalized Santa videos</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm">Send order confirmations and updates</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm">Provide assistance and resolve issues</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-gray-800">Service Improvement</h4>
                                                <p className="text-gray-600 text-sm">Analyze usage to enhance our platform</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm">Meet regulatory and legal requirements</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 text-sm">Send promotional content (with consent)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Information Sharing */}
                            <section id="information-sharing" data-section="information-sharing" className="mb-12">
                                <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <ul className="text-gray-700 space-y-3 pl-4">
                                        <li>• <strong>Service Providers:</strong> Trusted partners who help deliver our services (payment processors, email services)</li>
                            ...
                            <section id="cookies" data-section="cookies" className="mb-12">
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                                    <h4 className="font-semibold text-yellow-800 mb-2">Cookie Types</h4>
                                    <p className="text-yellow-700 text-sm">
                                        Essential cookies (required), Performance cookies (analytics), and Functional cookies (preferences)
                                    </p>
                                </div>
                            </section>

                            {/* Children's Privacy */}
                            <section id="children-privacy" data-section="children-privacy" className="mb-12">
                                <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center">
                                    <Shield className="w-8 h-8 text-red-600 mr-3" />
                                    Children's Privacy
                                </h2>
                                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                                    <p className="text-blue-800 font-semibold mb-2">Special Protection for Children</p>
                                    <p className="text-blue-700 text-sm leading-relaxed">
                                        We take extra care with children's information. We only collect the minimum necessary data to create personalized videos, and we never use children's information for marketing purposes. Parents have full control over their child's data and can request deletion at any time.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="contact" data-section="contact" className="mb-8">
                                ...
                                <div className="bg-gray-50 rounded-xl p-6">
                                    ...
                                    <div className="space-y-2 text-gray-600">
                                        ...
                                        <p>📍 Address: 123 Christmas Lane, North Pole, NP 12345</p>
                                    </div>
                                </div>
                            </section>
