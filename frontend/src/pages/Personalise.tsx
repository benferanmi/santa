          ...
          >
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/10 border border-black/70 rounded-2xl py-4 pl-12 pr-4 text-black placeholder-black/50 focus:outline-none focus:border-blue-400 focus:bg-white/15 transition-all duration-300"
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="" className="bg-white text-black">Select age</option>
                      {[...Array(13)].map((_, i) => (
                        <option key={i + 3} value={i + 3} className="bg-white text-black">
                          {i + 3} years old
                        </option>
                      ))}
                    </select>
            ...
            >
              <motion.button
                ...
                disabled={loading || !formData.childName || !formData.childAge}
                className="flex-1 bg-gradient-to-r from-red-800 to-red-700 text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-300 shadow-lg text-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gray-100 hover:bg-white/20 text-black border border-4 border-red-800 font-semibold py-4 px-8 rounded-2xl transition-all duration-300 backdrop-blur-sm"
              >
          ...
          >
                  ...
                  {formData.childName && (
                    <div className="mt-4 p-4 bg-white/10 rounded-lg">
                      <p className="text-black font-medium">
                        Preview: "Ho ho ho! Hello {formData.childName}! I hear you're {formData.childAge} years old..."
                      </p>
                    </div>
                  )}
                </motion.div>
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-amber-600 font-semibold mb-2">Delivery Info:</h4>
                  <p className="text-amber-500/90 text-sm leading-relaxed">
                    Your personalized Santa video will be delivered to your email within 24 hours after payment confirmation.
                  </p>
                </div>
              </div>
            </motion.div>
