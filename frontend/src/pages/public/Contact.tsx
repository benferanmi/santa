...
const ContactUsPage = () => {
  ...
  const contactMethods = [
    {
      ...
      description:
        "Drop us an email and we'll get back to you faster than Rudolph!",
  ...
  return (
    <AppLayout>
      <main className="bg-gradient-to-br from-red-50 via-white to-green-50 relative overflow-hidden">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              >
                Send your wishes to the North Pole! We're here to make your
                dreams come true ✨
              </motion.p>
              <motion.div
                  ...
                  <AnimatePresence>
                    {isSubmitted ? (
                      ...
                      >
                        ...
                        <p className="text-gray-600">
                          Your wish has been delivered to the North Pole. Santa
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-green-100 mb-8">
              Join millions of believers who trust us to make their dreams come
              true every day.
            </p>
            <motion.div
              className="flex justify-center space-x-4"
