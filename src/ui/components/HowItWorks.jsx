...
const HowItWorksSection = () => {
  const steps = [
    {
      ...
      icon: Edit3,
      title: "Enter Details",
      description: "Provide your child's name, age, and upload a photo of your front door.",
      accent: "emerald"
    },
    {
      number: "2", 
    ...
    },
    {
      ...
      description: "Get your personalised Santa video ready to share with your child.",
      accent: "purple"
    }
  ];
  ...
  const AnimatedDiv = ({ children, variant, className = "", delay = 0 }) => {
    ...
    const style = {
      ...
      transition: `all ${variant.transition?.duration || 0.6}s ${variant.transition?.ease || 'ease-out'} ${delay}s`
    };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedDiv variant={titleVariants} className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Creating your personalized Santa video is simple and takes just a few minutes
          </p>
        </AnimatedDiv>
              ...
              return (
                ...
                >
                  ...
                  {index < steps.length - 1 && (
                    <div className="absolute top-16 -right-6 w-12 h-0.5 bg-gray-200 z-0 hidden xl:block">
