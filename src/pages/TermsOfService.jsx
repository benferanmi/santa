...
const TermsOfServicePage = () => {
  ...
  const filteredTerms = termsData.filter(term =>
    ...
    term.content.some(content => content.toLowerCase().includes(searchTerm.toLowerCase()))
  );
            ...
            >
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  products, and services. By using our service, you agree to these terms in full.
                </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm leading-relaxed">
                      ...
                      by posting the new Terms of Service on this page. Your continued use of the service after 
