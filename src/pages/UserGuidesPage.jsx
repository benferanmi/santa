...
import { Search, ChevronRight, BookOpen, Users, Settings, Zap, HelpCircle, Star, Clock, ArrowRight } from 'lucide-react';
...
const UserGuidesPage = () => {
  ...
  const guides = [
    {
      ...
      description: 'Learn how to set up your account and get started with our platform in just a few minutes.',
    ...
    },
    {
      ...
      description: 'Customize your profile, update personal information, and configure privacy settings.',
      category: 'account',
      readTime: '8 min read',
      difficulty: 'Beginner',
      rating: 4.6,
    ...
    },
    {
      ...
      description: 'Dive deep into advanced settings to customize your experience and optimize performance.',
      category: 'settings',
    ...
    },
    {
      ...
      description: 'Solutions to the most frequently encountered problems and how to resolve them quickly.',
    ...
    },
    {
      ...
      description: 'Learn how to invite team members, manage permissions, and collaborate effectively.',
      category: 'account',
    ...
    },
    {
      ...
      description: 'A rapid introduction to get you up and running with the essential features immediately.',
      category: 'getting-started',
      readTime: '3 min read',
      difficulty: 'Beginner',
      rating: 4.7,
  ...
  return (
    <AppLayout className=" bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      {/* Header */}
      <motion.div
                ...
                {categories.map((category) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`w-full flex items-center px-4 py-3 rounded-lg text-left transition-all duration-200 ${selectedCategory === category.id
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                          >
                            {expandedGuide === guide.id ? 'Hide Steps' : 'View Guide'}
                            <ChevronRight className={`w-4 h-4 ml-1 transition-transform duration-200 ${expandedGuide === guide.id ? 'rotate-90' : ''
                              }`} />
                          </motion.button>
                        </div>
                      </div>
